...
---
# Résultat:
```{r imageplot2004, echo=FALSE, out.width="70%"}
...
---
# Résultat:
```{r imageplot1812, echo=FALSE, out.width="75%"}
include_graphics("img/plot_1812.png")
```

---
# Carte animée finale
Sur la prochaine diapositive on trouve l'animation finale, basée sur le graphique statique de 2004. L'année d'éruption médiane dans le jeu de données est 1830. Nous avons donc généré un premier gif de 100 *frames* pour la première moitié du jeu de données (jusqu'à 1830) et un 2e gif de 100 *frames* pour l'autre moitié du jeu de données. Ces deux gifs ont ensuite été mis un à la suite de l'autre. Générer un seul gif de 200 frames avait pour désavantage d'avoir un temps d'exportation très long.

---
# Résultat:
```{r gif, echo=FALSE, out.width="75%"}
...
>>>>>>> 72f2671144019c1cd06579db23ddd94561e63b81
